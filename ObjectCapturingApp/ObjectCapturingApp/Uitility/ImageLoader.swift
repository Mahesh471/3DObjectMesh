...
private let logger = getLogger(category: "ImageLoader")

// This class helps to load thumbnails and images from a file URL
class ImageLoader {
    ...
    // This method synchronously loads the Thumbnail image
    ...
    // This method synchronously loads the image
